...
def parse_args():
    ...
    parser.add_argument("--device", type=str, default="auto", choices=["auto", "cpu", "cuda", "mps"],
                         help="'auto' picks the best available device; use 'cuda' explicitly on Colab, 'cpu'/'mps' on a laptop")
...
def main():
    ...
    model = DQN(
        ...
        device=args.device,  # was hardcoded "cuda" for Colab; now configurable (default "auto")
    )
